...
Route::group(['middleware' => ['web']], function () {
	...
	Route::get('productores/getListado', [
	...
	Route::get('lotesPerfilUrl/getLotePerfilUrl/{perfil}', 'LotesController@getLotePerfilUrl');
...
Route::group(['prefix' => 'api'], function () {
	...
	Route::get('municipios', [
		'as'		=> 'municipios',
		'uses'	=> 'ApiController@getMunicipios'
	]);
	...
	Route::get('contactos', [
		'as'		=> 'contactos',
		'uses'	=> 'ApiController@getContacto'
	]);
