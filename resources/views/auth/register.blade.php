                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" placeholder="ingrese so nombre completo" name="name" value="{{ old('name') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input type="email" class="form-control" placeholder="ingrese su correo electronico" name="email" value="{{ old('email') }}">
